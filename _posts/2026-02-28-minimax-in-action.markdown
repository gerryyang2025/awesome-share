...
MiniMax 开放平台另提供 **Token Plan** 按月/按年订阅，覆盖文本（如 M2.7）、语音、图像、视频等产品的用量配额。完整档位与条款以官方文档为准：[Token Plan](https://platform.minimaxi.com/docs/guides/pricing-token-plan)。订阅入口：[去订阅](https://platform.minimaxi.com/subscribe/token-plan)。

以下为官方文档中的定价表摘录（若有变更以官网为准）。
...
| :-- | :-- | :-- | :-- |
| **价格** | **¥98 / 月** | **¥199 / 月** | **¥899 / 月** |
| **M2.7-highspeed** | 1,500 次请求 / 5 小时 | 4,500 次请求 / 5 小时 | 30,000 次请求 / 5 小时 |
